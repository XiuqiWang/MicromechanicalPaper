...
# plt.figure()
# for i in range(5):
#     plt.scatter(Vim_all_Omega[i], Thetaim_all_Omega[i], color=colors[i])
#     plt.scatter(VD_all_Omega[i], ThetaD_all_Omega[i], color=colors[i])
# plt.xlabel(r'$U_\mathrm{inc}$')
# plt.ylabel(r'$\theta_\mathrm{inc}$')
