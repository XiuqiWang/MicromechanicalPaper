...
CORmean_glo, CORstd_glo, CORstderr_glo, N_COR, Thetare_mean_glo, Thetare_std_glo, Thetare_stderr_glo, Uimplot = module.BinUimCOR_equalbinsize(Vim_all_values,Vre_all_values,Thetare_all_values,Vim_bin)
Pr_glo,Uplot,N_PrUre, Uiminbin, UDinbin = module.BinUimUd_equalbinsize(Vim_all_values,VD_all_values,Vimde_bin)
NEmean_glo, UEmean_glo, UEstd_glo, UEstderr_glo, ThetaEmean_glo, ThetaEstd_glo, ThetaEstderr_glo, N_Einbin, Uplot_NE = module.get_ejection_ratios_equalbinsize(matched_Vim_all, VD_all_values, matched_NE_all, matched_UE_all, matched_thetaE_all, Vimde_bin)
...
plt.subplot(3,2,1)
line1 = plt.errorbar(Uimplot/constant, CORmean_glo, CORstd_glo, fmt='o', capsize=5, label='This study', color='#3776ab')
...
plt.text(0.02, 0.92, '(a)', transform=plt.gca().transAxes, fontsize=16, fontweight='bold')
plt.subplot(3,2,2)
line1 = plt.errorbar(Uimplot/constant, Thetare_mean_glo, yerr=Thetare_std_glo, fmt='o', capsize=5, label='This study', color='#3776ab')
...
plt.subplot(3,2,6)
line1 = plt.errorbar(Uplot_NE/constant, ThetaEmean_glo, yerr=ThetaEstd_glo, fmt='o', capsize=5, label='This study', color='#3776ab')
