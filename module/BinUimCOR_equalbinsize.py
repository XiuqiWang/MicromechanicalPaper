...
def BinUimCOR_equalbinsize(velocities_im,velocities_re,cors,thetares,vel_bins):
    ...
    return cor_means,cor_stds,cor_stderrs,Ure_mean, Ure_stderr,thetare_mean,thetare_stderr,Ure_Uim,Uplot